...
export default {
  ...
  teams: {
    ...
    noAdminAssigned: 'لم يتم تعيين مسؤول فريق بعد',
    memberBadgeAdmin: 'مسؤول',
    noMembersYet: 'لا يوجد أعضاء بعد',
    newTeamTitle: 'فريق جديد',
    teamNameLabel: 'اسم الفريق',
    teamNamePlaceholder: 'مثال: فرع 2 - وسط المدينة',
    addLeaderHint: 'بعد إنشاء الفريق، أضف قائده من تبويب الأشخاص.',
    createTeam: 'إنشاء فريق',
    genericError: 'تعذر إنشاء الفريق.',
  },
  mainTabs: {
    myTasks: 'مهامي',
